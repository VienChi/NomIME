...
class NomIMEServerApp {
 public:
  ...
  static bool check_update() {
    ...
    std::wstring channel{};
    auto ret = RegGetStringValue(HKEY_CURRENT_USER, L"Software\\SinoNom\\NomIME",
 ...
 protected:
  ...
  nomime::Server m_server;
  nomime::UI m_ui;
  NomIMETrayIcon tray_icon;
  std::unique_ptr<RimeWithNomIMEHandler> m_handler;
};
