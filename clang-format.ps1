...
$NOMIME_SOURCE_PATH = @("RimeWithNomIME", "NomIMEDeployer",
  "NomIMEIPC", "NomIMEIPCServer", "NomIMEServer", "NomIMESetup",
  "NomIMETSF", "NomIMEUI", "include", "test")
...
$NOMIME_SOURCE_PATH | ForEach-Object {
