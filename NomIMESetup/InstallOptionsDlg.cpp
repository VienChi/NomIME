...
LRESULT InstallOptionsDialog::OnInitDialog(UINT, WPARAM, LPARAM, BOOL&) {
  ...
  CheckRadioButton(IDC_RADIO_CN, IDC_RADIO_VI,
                   (vi ? IDC_RADIO_VI : IDC_RADIO_CN));
  CheckRadioButton(
...
LRESULT InstallOptionsDialog::OnOK(WORD, WORD code, HWND, BOOL&) {
  vi = (IsDlgButtonChecked(IDC_RADIO_VI) == BST_CHECKED);
