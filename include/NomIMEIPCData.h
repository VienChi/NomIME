...
void serialize(Archive& ar, nomime::UIStyle& s, const unsigned int version) {
  ar & s.font_face;
...
template <typename Archive>
void serialize(Archive& ar, nomime::Text& s, const unsigned int version) {
  ar & s.str;
  ar & s.attributes;
}
template <typename Archive>
void serialize(Archive& ar,
               nomime::TextAttribute& s,
               const unsigned int version) {
  ar & s.range;
  ar & s.type;
}
template <typename Archive>
void serialize(Archive& ar, nomime::TextRange& s, const unsigned int version) {
  ar & s.start;
  ar & s.end;
  ar & s.cursor;
}
