...
// data directories
std::filesystem::path NomIMESharedDataPath();
std::filesystem::path NomIMEUserDataPath();
inline fs::path NomIMELogPath() {
  WCHAR _path[MAX_PATH] = {0};
  // default location
  ExpandEnvironmentStringsW(L"%TEMP%\\rime.nomime", _path, _countof(_path));
...
inline std::wstring get_nomime_ime_name() {
