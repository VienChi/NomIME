...
class CCandidateList : public ITfIntegratableCandidateListUIElement,
 ...
 public:
  CCandidateList(com_ptr<NomIMETSF> pTextService);
  ~CCandidateList();
  ...
  /* Update */
  void UpdateUI(const nomime::Context& ctx, const nomime::Status& status);
  void UpdateStyle(const nomime::UIStyle& sty);
