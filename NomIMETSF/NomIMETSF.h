...
class NomIMETSF : public ITfTextInputProcessorEx,
 ...
 public:
  ...
  /* UI */
  void _UpdateUI(const nomime::Context& ctx, const nomime::Status& status);
  void _StartUI();
  void _EndUI();
  void _ShowUI();
  void _HideUI();
 ...
 private:
  ...
  void _UpdateLanguageBar(nomime::Status stat);
  ...
  /* NomIME Related */
  nomime::Client m_client;
  DWORD _activateFlags;

  /* IME status */
  nomime::Status _status;
