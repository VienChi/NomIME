...
STDAPI NomIMETSF::OnEndEdit(ITfContext* pContext,
...
STDAPI NomIMETSF::OnLayoutChange(ITfContext* pContext,
                                 TfLayoutCode lcode,
...
BOOL NomIMETSF::_InitTextEditSink(com_ptr<ITfDocumentMgr> pDocMgr) {
