...
class NomIMEPanel
    : public CWindowImpl<NomIMEPanel, CWindow, CNomIMEPanelTraits>,
      CDoubleBufferImpl<NomIMEPanel> {
 public:
  BEGIN_MSG_MAP(NomIMEPanel)
  ...
  CHAIN_MSG_MAP(CDoubleBufferImpl<NomIMEPanel>)
  END_MSG_MAP()
 ...
 private:
  ...
  nomime::Layout* m_layout;
  nomime::Context& m_ctx;
  nomime::Context& m_octx;
  nomime::Status& m_status;
  nomime::UIStyle& m_style;
  nomime::UIStyle& m_ostyle;
